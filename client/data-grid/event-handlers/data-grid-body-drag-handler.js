/**
 * data-grid-body 의 drag handler
 *
 * - handler의 this 는 data-grid-body임.
 */
export const dataGridBodyDragHandler = function(e) {
  var onMouseMove = _onMousemove.bind(this)
  this.shadowRoot.addEventListener('mousemove', onMouseMove)
  
  const onMouseUp = (e) => {
    this.shadowRoot.removeEventListener('mousemove', onMouseMove)
